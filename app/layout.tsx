...
export const metadata: Metadata = {
  title: 'MediSupply AI - Find the Right Medical Supplies, Every Time',
  description: 'A global platform helping medical professionals easily find and compare medical supplies, leveraging AI for optimal matching and supplier verification.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  var TOKEN="a296fe1b-a678-494a-b27d-39ee8c4e07a3cc766d4166ccf495a18ad8441a47f667";
